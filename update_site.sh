...
line=62
gsed -i "${line}i <table class=\"imgtable\"> <td style=\"width:50%\"> <h2>Research Interests</h2> <p>data mining, machine learning, social network anlaysis, recommender systems, deep learning on graphs, responsible and trustworthy AI, and interdisciplinary social good applications (e.g., drug discovery, education, political science, and neurodiversity) <p><b> <font color=\"red\">[Open positions]</font><br> I am recruiting PhD students to work with us in the NDS Lab on topics in our general interests (see NDS Lab research interests to the right).</b> Master's and undergraduate students within Vanderbilt University and visiting scholars are also welcome. Please feel free to email me. <br><b>Please see <a href=\"openings.html\">here</a> for position details.</b></p> <h2>Call for Papers</h2> <ul> <li> <p> Machine Learning on Graphs in the Era of Artificial General Intelligence Workshop at KDD'25 (<a href=\"https://mlgraphworkshop.github.io/\"><font color=\"red\">Link to Details</font></a>) </p> <ul> <li> <p> Workshop Organizer along with Yu Wang, Yu Zhang, Zhichun Guo, Nesreen Ahmed, and Jiliang Tang </p> </li> <li> <p> Submission Deadline: May 8th, 2025 </p> </li> </ul> </li> </ul> </td> <td> <a href=\"https://nds-vu.github.io/research/\"> <img src=\"images/NDS_overview.png\" alt=\"Image of NDS Research\" width=\"500px\" /> </a>&nbsp;</td> </table>" index.html
