...
line=61
gsed -i "${line}i <table class=\"imgtable\"> <td style=\"width:50%\"> <h2>Selected Highlights</h2> (see full <a href=\"TylerDerr_CV.pdf\">CV</a> for complete details) <h3>Awards \& Recognition</h3> <ul> <li> NSF CAREER Award (2023) </li> <li> NVIDIA Academic Grant Program Award (2024) </li> <li> Young Investigator Best Paper Award - KDD'25 Health Day </li> <li> Best Paper Award - GLFrontiers Workshop at NeurIPS'23 </li> <li> Teaching Innovation Award - VU Engineering Fall'20 </li> <li> Vanderbilt Career Catalyst Impact Award (2025) </li> </ul> <h3> Leadership \& Service </h3> <ul> <li> Associate Editor: ACM TKDD, IEEE TBD, Tsinghua Science and Technology </li> <li> Organizing Committees: KDD, CIKM, SDM, DSAA, WSDM </li> <li> Tutorials at AAAI, KDD, CIKM, SDM </li> <li> 40+ invited talks at leading universities, institutes, and industry labs worldwide </li> </ul> <h2>Research Interests</h2> <p> Data mining; machine learning; deep learning on graphs; network science; large language models and AI agents; data-centric AI; responsible and trustworthy AI; social network analysis; recommender systems; and AI for scientific and societal applications, including computational drug discovery <p><b> <font color=\"red\">[Open positions]</font><br> I am recruiting PhD students to work with us in the NDS Lab on topics in our general interests (see NDS Lab research interests to the right).</b> Master's and undergraduate students within Vanderbilt University and visiting scholars are also welcome. Please feel free to email me. <br><b>Please see <a href=\"openings.html\">here</a> for position details.</b></p> </td> <td> <a href=\"https://nds-vu.github.io/research/\"> <img src=\"images/NDS_overview.png\" alt=\"Image of NDS Research\" width=\"500px\" /> </a>&nbsp;</td> </table>" index.html

# <h2>Call for Papers</h2> <ul> <li> <p> Machine Learning on Graphs in the Era of Artificial General Intelligence Workshop at KDD'25 (<a href=\"https://mlgraphworkshop.github.io/\"><font color=\"red\">Link to Details</font></a>) </p> <ul> <li> <p> Workshop Organizer along with Yu Wang, Yu Zhang, Zhichun Guo, Harry Shomer, Haoyu Han, Nesreen Ahmed, Mahantesh Halappanavar, and Jiliang Tang </p> </li> <li> <p> Submission Deadline: May 31th, 2025 </p> </li> </ul> </li> </ul>
