...
gsed -i "${line}i <script type=\"text/javascript\" id=\"clustrmaps\" src=\"//cdn.clustrmaps.com/map_v2.js?d=leIDuRwlUzsESOVq6m32RqbgLChp2xkZYp22IZ7\QInU&cl=ffffff&w=a\"></script>" bjtu.html
...
line=62
gsed -i "${line}i <table class=\"imgtable\"> <td style=\"width:50%\"> <h2>Research Interests</h2> <p>data mining, machine learning, social network anlaysis, recommender systems, deep learning on graphs, responsible and trustworthy AI, and interdisciplinary social good applications (e.g., drug discovery, education, political science, and neurodiversity) <p><b> <font color=\"red\">[Open positions]</font><br> I am recruiting PhD students to work with us in the NDS Lab on topics in our general interests (see NDS Lab research interests to the right).</b> Master's and undergraduate students within Vanderbilt University and visiting scholars are also welcome. Please feel free to email me. <br><b>Please see <a href=\"openings.html\">here</a> for position details.</b></p> <h2>Call for Papers</h2> <ul> <li> <p> ACM Transactions on Intelligent Systems and Technology (TIST) Special Issue on Transformers (<a href=\"https://dl.acm.org/pb-assets/static_journal_pages/tist/pdf/ACM-TIST-CFP-SI-Transformers-1719857985893.pdf\"><font color=\"red\">Link to Details</font></a>) </p> <ul> <li> <p> Guest Editor along with Feng Xia, Luu Anh Tuan, Richa Singh, and Aline Villavicencio </p> </li> <li> <p> Submission Deadline: December 1st, 2024 </p> </li> </ul> </li> <li><p><a href=\"https://gta3.hrl.com/\">The 8th Workshop on Graph Techniques for Adversarial Activity Analytics (GTA3) at ACM CIKM'24</a> - Workshop Organizer</p> <ul> <li><p>Submission Deadline: August 16th, 2024</p> </li> </ul> </td> <td> <a href=\"https://nds-vu.github.io/research/\"> <img src=\"images/NDS_overview.png\" alt=\"Image of NDS Research\" width=\"500px\" /> </a>&nbsp;</td> </table>" index.html
